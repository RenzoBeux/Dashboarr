...
test("rtorrent, transmission, lidarr, jellystat, unraid and jackett are accepted kinds", () => {
  for (const kind of ["rtorrent", "transmission", "lidarr", "jellystat", "unraid", "jackett"]) {
    const result = configPayloadSchema.safeParse({
