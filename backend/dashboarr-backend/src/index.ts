...
async function writeWebhookUrlsFile(publicUrl: string, dataDir: string): Promise<string> {
  ...
  for (const id of SERVICE_IDS) {
    if (id === "qbittorrent" || id === "transmission" || id === "deluge" || id === "prowlarr" || id === "plex" || id === "jellyfin" || id === "emby" || id === "glances" || id === "autobrr" || id === "cleanuparr" || id === "nzbhydra2" || id === "navidrome" || id === "beszel") continue;
